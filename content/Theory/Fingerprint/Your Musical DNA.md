...
![Chart](https://lerugray.github.io/le-rug-musical-dna/images/Your-Musical-DNA-2.png)


| Pitch | Count | Note |
|---|---|---|
| **E** | 9,820 | Open low E and high E strings |
| **G** | 9,315 | Open G string, power chord 3rd fret |
| **C** | 8,145 | Common in chord shapes |
| **A** | 8,141 | Open A string |
| **D** | 6,923 | Open D string |
| **B** | 6,582 | Open B string |
| F | 4,902 | |
| F# | 4,318 | 2nd fret on low E |
| C# | 2,789 | |
| D# | 2,760 | |
| G# | 2,686 | |
| A# | 2,208 | Least used |
...
![Chart](https://lerugray.github.io/le-rug-musical-dna/images/Your-Musical-DNA-3.png)
...
![Chart](https://lerugray.github.io/le-rug-musical-dna/images/Your-Musical-DNA-4.png)
...
`octave down -> octave up -> octave down`
*Rapidly alternating between the same note in two octaves. Your #1 move.*
...
### "The Pedal"
`octave down -> repeat -> repeat`
*Drop an octave then hammer on the same note. Anchoring.*

### "The Shimmer"
`octave up -> repeat -> octave down`
*Leap up, sit there, fall back. The Built to Spill sparkle.*
